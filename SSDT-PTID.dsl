 ...
 * 
 * Disassembly of SSDT-PTID.aml, Wed Jan 30 12:26:20 2013
 *
...
DefinitionBlock ("SSDT-PTID.aml", "SSDT", 1, "TrmRef", "PtidDevc", 0x00001000)
{
    ...
    Scope (\_SB)
    {
        Device (PTID)
        {
            ...
            Name (TSDL, Package (0x2E) //temperature
            {
                Zero, 
                "CPU Core 0 DTS", 
                Zero, 
            ...
            Name (OSDL, Package (0x06) //optional
            {
                Zero, 
                "CPU Fan Speed", 
                "RPM", 
