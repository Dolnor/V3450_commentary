...
DefinitionBlock ("C:/Users/Dmitry Seryogin/Desktop/acpi_dsdt.aml", "DSDT", 2, "DELL  ", "SNB-CPT", 0x00000000)
{
    ...
    {
        OSYS,   16, //Operating System Identifier
        SMIF,   8, 
        PRM0,   8, 
        PRM1,   8, 
        SCIF,   8, 
        ...
        P80D,   32, 
        LIDS,   8, //LID Status
        PWRS,   8, //Running on AC Power (gets value from ACIN EC 0x40 bit 1)
        DBGS,   8, 
        THOF,   8, 
        ACT1,   8, 
        ...
        ALFP,   8, 
        IMON,   8, 
        PDTS,   8, //CPU Core Package DTS
        PKGA,   8, 
        PAMT,   8, 
        AC0F,   8, 
        AC1F,   8, 
        DTS3,   8, //CPU Core 2 DTS
        DTS4,   8  //CPU Core 3 DTS
    }
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (EC0)
                {
                    ...
                    OperationRegion (ECRM, EmbeddedControl, 0x00, 0x0100)
                    Field (ECRM, ByteAcc, Lock, Preserve)
                    {
                        ...
                        KLED,   8, 
                        Offset (0x80), 
                        ACTP,   8, // 0x80 AC charger type (Wattage) 0x41=65W / 0x87=135W
                        Offset (0x82), 
                        NOS0,   8, 
                        Offset (0x89), 
                        ACOS,   8, // 0x89 Active Operatig Sytem (W7 and W8 are 0x80)
                        Offset (0x8B), 
                    ...
                    {
                        P8XH (Zero, 0xB0)
                        If (LOr (LOr (LOr (LEqual (OSYS, 0x03E8), LEqual (OSYS, 0x07D1)), 
                            LOr (LEqual (OSYS, 0x07D2), LEqual (OSYS, 0x07D3))), LOr (LEqual (OSYS, 0x07D6), 
                            LEqual (OSYS, 0x07D9))))
                        {
                            Store (0xAC, SSMP)
                            Store (BSBF, SBF0)
